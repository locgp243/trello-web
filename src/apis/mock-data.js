export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'GiaLocDev MERN Stack Board',
    ...
    columns: [
      ...
      /**
       * Phía FE sẽ tạo 1 card đặc biệt Placeholder Card không liên quan đến BackEnd
       * Card đặc biệt này để ẩn ở giao diện UI người dùng
       ...
       * Quan trọng khi khởi tạo phải đầy đủ (_id, boardId, columnId, FE_PlaceholderCard)
       */
      {
        _id: 'column-id-04',
        boardId: 'board-id-01',
